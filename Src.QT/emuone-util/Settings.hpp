...
{
    class EMUONE_UTIL_PUBLIC AbstractSetting;

    /// \class Settings emuone-util/API.hpp
    /// \brief A bunch of related settings.
    /// \details
    ///     Concrete subclasses will normally be singletons.
    class EMUONE_UTIL_PUBLIC Settings
    {
        EMUONE_CANNOT_ASSIGN_OR_COPY_CONSTRUCT(Settings)
    ...
    /// \class AbstractSetting emuone-util/API.hpp
    /// \brief A generic "settings" is a single value which is retained between runs.
    class EMUONE_UTIL_PUBLIC AbstractSetting
        :   public QObject
    {
        Q_OBJECT
        EMUONE_CANNOT_ASSIGN_OR_COPY_CONSTRUCT(AbstractSetting)
    ...
    protected:
        ...
        ///     True if changes to the setting's values require EmuOne
    ...
    /// \class Setting emuone-util/API.hpp
    /// \brief A "settings" is a single value which is retained between runs.
    template <class T>
    class Setting final
        :   public AbstractSetting
    {
        EMUONE_CANNOT_ASSIGN_OR_COPY_CONSTRUCT(Setting)
