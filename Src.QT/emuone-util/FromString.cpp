//
//  emuone-util/FromString.cpp - Value parsing framework
//
//  EmuOne
...
//  C++ types
template <> EMUONE_UTIL_PUBLIC bool emuone::util::fromString<bool>(const QString & s, qsizetype & scan)
{
    if (scan < 0)
    {
...
template <> EMUONE_UTIL_PUBLIC char emuone::util::fromString<char>(const QString & s, qsizetype & scan)
{
...
template <> EMUONE_UTIL_PUBLIC signed char emuone::util::fromString<signed char>(const QString & s, qsizetype & scan)
{
...
template <> EMUONE_UTIL_PUBLIC unsigned char emuone::util::fromString<unsigned char>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
...
template <> EMUONE_UTIL_PUBLIC signed short emuone::util::fromString<signed short>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    signed long long temp = fromString<signed long long>(s, prescan);
...
template <> EMUONE_UTIL_PUBLIC unsigned short emuone::util::fromString<unsigned short>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    unsigned long long temp = fromString<unsigned long long>(s, prescan);
...
template <> EMUONE_UTIL_PUBLIC signed int emuone::util::fromString<signed int>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    signed long long temp = fromString<signed long long>(s, prescan);
...
template <> EMUONE_UTIL_PUBLIC unsigned int emuone::util::fromString<unsigned int>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    unsigned long long temp = fromString<unsigned long long>(s, prescan);
...
template <> EMUONE_UTIL_PUBLIC signed long emuone::util::fromString<signed long>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    signed long long temp = fromString<signed long long>(s, prescan);
...
template <> EMUONE_UTIL_PUBLIC unsigned long emuone::util::fromString<unsigned long>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    unsigned long long temp = fromString<unsigned long long>(s, prescan);
...
template <> EMUONE_UTIL_PUBLIC signed long long emuone::util::fromString<signed long long>(const QString & s, qsizetype & scan)
{
    if (scan < 0)
    {
        throw ParseException(s, scan);
...
template <> EMUONE_UTIL_PUBLIC unsigned long long emuone::util::fromString<unsigned long long>(const QString & s, qsizetype & scan)
{
...
template <> EMUONE_UTIL_PUBLIC float emuone::util::fromString<float>(const QString & s, qsizetype & scan)
{
    return static_cast<float>(fromString<double>(s, scan));
}

template <> EMUONE_UTIL_PUBLIC double emuone::util::fromString<double>(const QString & s, qsizetype & scan)
{
    if (scan < 0 || scan >= s.length())
    {
        throw ParseException(s, scan);
...
//  QT types
template <> EMUONE_UTIL_PUBLIC QChar emuone::util::fromString<QChar>(const QString & s, qsizetype & scan)
{
    if (scan >= 0 && scan < s.length())
    {
        return s[scan++];
...
template <> EMUONE_UTIL_PUBLIC QString emuone::util::fromString<QString>(const QString & s, qsizetype & scan)
{
    if (scan >= 0 && scan <= s.length())
    {
...
template <> EMUONE_UTIL_PUBLIC QRect emuone::util::fromString<QRect>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
    int x1, x2, y1, y2;
...
template <> EMUONE_UTIL_PUBLIC QVersionNumber emuone::util::fromString<QVersionNumber>(const QString & s, qsizetype & scan)
{
    qsizetype prescan = scan;
...
template <> EMUONE_UTIL_PUBLIC QLocale emuone::util::fromString<QLocale>(const QString & s, qsizetype & scan)
{
    if (scan < 0 || scan > s.length())
    {
        throw ParseException(s, scan);
...
template <> EMUONE_UTIL_PUBLIC QColor emuone::util::fromString<QColor>(const QString & s, qsizetype & scan)
{
...
template <> EMUONE_UTIL_PUBLIC QDateTime emuone::util::fromString<QDateTime>(const QString & s, qsizetype & scan)
{
...
template <> EMUONE_UTIL_PUBLIC QDate emuone::util::fromString<QDate>(const QString & s, qsizetype & scan)
{
