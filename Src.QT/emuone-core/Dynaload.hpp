//
//  emuone-core/Dynaload.hpp - Dynamic loading support
//
//  EmuOne
...
{
    /// \class Component emuone-core/API.hpp
    /// \brief the emuone-core component.
    class EMUONE_CORE_PUBLIC Component final
...
//  End of emuone-core/Dynaload.hpp
