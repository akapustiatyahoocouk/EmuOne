//
//  emuone-core/Component.cpp - VM component
//
//  EmuOne
...
namespace emuone::core
{
    ...
    public:
        /// \brief
        ///     Returns the small (16x16) image representing this Component.
        /// \return
        ///     The small (16x16) image representing this Component.
        virtual QImage  smallImage() const;

        /// \brief
        ///     Returns the large (32x32) image representing this Component.
        /// \return
        ///     The large (32x32) image representing this Component.
    ...
    public:
        ...
        //  Implementation
    private:
        mutable QRecursiveMutex _guard; //  for all mofdifications
